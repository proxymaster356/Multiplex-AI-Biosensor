...
├── pipeline/                          ← Core AI & signal processing components
│   ├── __init__.py 
...
├── static/                            ← Web dashboard UI (CSS)
├── templates/                         ← Web dashboard UI (HTML)
...
├── instruction.txt                    ← Developer notes and instructions
