...
│
├── assets/
│       ai_multiplex_biosensor_pipeline.png
│       ai_multiplex_biosensor_pipeline.svg
│
├── data/
│       biosensor_200_samples.csv
│       biosensor_detailed_500.csv
│       biosensor_full_results.csv
│       biosensor_ground_truth.csv
│       biosensor_metadata.json
│       biosensor_predictions.csv
│       biosensor_shap.csv
│       sample_device_input.csv
│
├── docs/
│       biosensor_eval_report.txt
│       biosensor_system_explainer.txt
│       detailed_structure.doc
│
├── pipeline/
│   │   clinical_report.py
│   │   models.py
│   │   multimodal_encoder.py
│   │   real_device_adapter.py
│   │   signal_processor.py
│   │   train_pipeline.py
│   │   __init__.py
│
├── references/
│       Amplification Free CRISPR Cas12aBased Electrochemical Biosensor with Enhanced Sensitivity for Viral Detection.pdf
│       Construction of Electrochemical Biosensors Based on the CRISPR Cas12 System for Applications.pdf
│       Development of a Universal Electrochemical Biosensor.pdf
│       d1ay00725d -- Anna's Archive.pdf
│
├── reports/
│       biosensor_eval_report.txt
│       report_BIO0004.html
